...
<p><a href="#" onClick="pokaz()">Трудозатраты</a></p>
<div id="descr" style="visibility: hidden">
<p>Введите дату:<br>
<input type="date" id="cp_timesheet_date" name="cp_timesheet_date" /></p>
<p>Введите часы:<br>
...
add_action('comment_post', 'cp_timesheet_datetime_save');
add_action('comment_post', 'cp_timesheet_hours_save');
add_action('comment_post', 'cp_timesheet_minutes_save');
